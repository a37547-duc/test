          ...
          <table role="presentation" style="width: 100%; max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; padding: 20px;">
            <tr>
              <td style="text-align: center; padding-bottom: 20px;">
                <h1 style="font-size: 24px; color: #333333; margin: 0;">Xác Nhận Thanh Toán Thành Công</h1>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td>
                ...
                <tr>
                  ...
                  <tr>
                    <th style="padding: 10px; background-color: #f1f1f1; text-align: left; font-weight: bold; color: #333333;">Trạng thái thanh toán</th>
                    <td style="padding: 10px; border: 1px solid #dddddd; color: #333333;">${paymentStatus}</td>
                  </tr>
                  <tr>
